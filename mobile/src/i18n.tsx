...
const en = {
  ...
  methodCard: "Card · Google Pay",
  methodPaypal: "PayPal",
  methodCash: "Pay at the restaurant",
  methodCashDelivery: "Pay on delivery",
  payHintCard: "Secure payment via Stripe. Google Pay if set up on this phone.",
...
const de: Strings = {
  ...
  methodCard: "Karte · Google Pay",
  methodPaypal: "PayPal",
  methodCash: "Im Restaurant zahlen",
  methodCashDelivery: "Bei Lieferung zahlen",
  payHintCard:
    "Sichere Zahlung über Stripe. Google Pay, wenn es auf diesem Handy eingerichtet ist.",
...
const it: Strings = {
  ...
  methodCard: "Carta · Google Pay",
  methodPaypal: "PayPal",
  methodCash: "Paga al ristorante",
  methodCashDelivery: "Paga alla consegna",
  payHintCard: "Pagamento sicuro tramite Stripe. Google Pay se è configurato su questo telefono.",
...
const es: Strings = {
  ...
  paymentMethod: "Pago",
  methodCard: "Tarjeta · Google Pay",
  methodPaypal: "PayPal",
  methodCash: "Pagar en el restaurante",
  methodCashDelivery: "Pagar en la entrega",
  payHintCard: "Pago seguro con Stripe. Google Pay si lo tienes configurado en este teléfono.",
...
const ar: Strings = {
  ...
  paymentMethod: "الدفع",
  methodCard: "بطاقة · Google Pay",
  methodPaypal: "باي بال",
  methodCash: "الدفع في المطعم",
  methodCashDelivery: "الدفع عند التوصيل",
  payHintCard: "دفع آمن عبر Stripe، ومن خلال Google Pay إذا كان مُفعّلاً على هذا الهاتف.",
