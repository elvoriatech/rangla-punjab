...
const it: Strings = {
  ...
  payAfterOrder: "Paga online dopo l'ordine oppure al ristorante.",
  ...
  payOnline: "Paga online (carta / PayPal)",
...
const es: Strings = {
  ...
  payAfterOrder: "Paga online después de pedir, o en el restaurante.",
  ...
  payOnline: "Pagar online (tarjeta / PayPal)",
...
const ar: Strings = {
  ...
  payAfterOrder: "ادفع عبر الإنترنت بعد الطلب، أو في المطعم.",
  ...
  payOnline: "الدفع عبر الإنترنت (بطاقة / باي بال)",
