...
const en = {
  ...
  exitTitle: "Payment not completed",
  exitBody:
    "Your order has not been paid, so the kitchen has not received it yet. What would you like to do?",
  exitTryCard: "Try card payment again",
  exitPayCash: "Pay cash at the restaurant",
  exitCancel: "Cancel order",
  exitCancelConfirm: "Cancel this order? It hasn't been paid and nothing will be charged.",
  exitWorking: "One moment…",
  exitCashDoneTitle: "Order sent to the kitchen",
  exitCashDoneBody: "You pay in cash at the restaurant.",
  exitCancelledTitle: "Order cancelled",
  exitCancelledBody: "Nothing was charged.",
  exitStillProcessing:
    "The payment is still being processed. Please wait a moment and reload this page.",
  exitAlreadyPaid: "This order is already paid.",
  exitFailed: "That didn't work. Please try again or ask the restaurant.",
  exitClose: "Close",
  exitOtherOptions: "Other options",
...
const de: PostOrderCopy = {
  ...
  exitTitle: "Zahlung nicht abgeschlossen",
  exitBody:
    "Deine Bestellung ist nicht bezahlt, daher hat die Küche sie noch nicht erhalten. Was möchtest du tun?",
  exitTryCard: "Kartenzahlung erneut versuchen",
  exitPayCash: "Bar im Restaurant bezahlen",
  exitCancel: "Bestellung stornieren",
  exitCancelConfirm:
    "Diese Bestellung stornieren? Sie ist nicht bezahlt und es wird nichts abgebucht.",
  exitWorking: "Einen Moment…",
  exitCashDoneTitle: "Bestellung an die Küche gesendet",
  exitCashDoneBody: "Du bezahlst bar im Restaurant.",
  exitCancelledTitle: "Bestellung storniert",
  exitCancelledBody: "Es wurde nichts abgebucht.",
  exitStillProcessing:
    "Die Zahlung wird noch verarbeitet. Bitte warte kurz und lade die Seite neu.",
  exitAlreadyPaid: "Diese Bestellung ist bereits bezahlt.",
  exitFailed: "Das hat nicht geklappt. Bitte versuche es erneut oder wende dich an das Restaurant.",
  exitClose: "Schließen",
  exitOtherOptions: "Andere Möglichkeiten",
...
const fr: PostOrderCopy = {
  ...
  exitTitle: "Paiement non finalisé",
  exitBody:
    "Votre commande n’est pas payée, la cuisine ne l’a donc pas encore reçue. Que souhaitez-vous faire ?",
  exitTryCard: "Réessayer le paiement par carte",
  exitPayCash: "Payer en espèces au restaurant",
  exitCancel: "Annuler la commande",
  exitCancelConfirm: "Annuler cette commande ? Elle n’est pas payée et rien ne sera débité.",
  exitWorking: "Un instant…",
  exitCashDoneTitle: "Commande envoyée en cuisine",
  exitCashDoneBody: "Vous payez en espèces au restaurant.",
  exitCancelledTitle: "Commande annulée",
  exitCancelledBody: "Rien n’a été débité.",
  exitStillProcessing:
    "Le paiement est encore en cours. Patientez un instant puis rechargez la page.",
  exitAlreadyPaid: "Cette commande est déjà payée.",
  exitFailed: "Cela n’a pas fonctionné. Réessayez ou contactez le restaurant.",
  exitClose: "Fermer",
  exitOtherOptions: "Autres options",
...
const es: PostOrderCopy = {
  ...
  exitTitle: "Pago no completado",
  exitBody:
    "Tu pedido no está pagado, así que la cocina aún no lo ha recibido. ¿Qué quieres hacer?",
  exitTryCard: "Reintentar el pago con tarjeta",
  exitPayCash: "Pagar en efectivo en el restaurante",
  exitCancel: "Cancelar pedido",
  exitCancelConfirm: "¿Cancelar este pedido? No está pagado y no se cobrará nada.",
  exitWorking: "Un momento…",
  exitCashDoneTitle: "Pedido enviado a la cocina",
  exitCashDoneBody: "Pagas en efectivo en el restaurante.",
  exitCancelledTitle: "Pedido cancelado",
  exitCancelledBody: "No se ha cobrado nada.",
  exitStillProcessing: "El pago aún se está procesando. Espera un momento y recarga la página.",
  exitAlreadyPaid: "Este pedido ya está pagado.",
  exitFailed: "No ha funcionado. Inténtalo de nuevo o contacta con el restaurante.",
  exitClose: "Cerrar",
  exitOtherOptions: "Otras opciones",
...
const it: PostOrderCopy = {
  ...
  exitTitle: "Pagamento non completato",
  exitBody:
    "Il tuo ordine non è pagato, quindi la cucina non l'ha ancora ricevuto. Cosa vuoi fare?",
  exitTryCard: "Riprova il pagamento con carta",
  exitPayCash: "Paga in contanti al ristorante",
  exitCancel: "Annulla ordine",
  exitCancelConfirm: "Annullare questo ordine? Non è pagato e non verrà addebitato nulla.",
  exitWorking: "Un momento…",
  exitCashDoneTitle: "Ordine inviato in cucina",
  exitCashDoneBody: "Paghi in contanti al ristorante.",
  exitCancelledTitle: "Ordine annullato",
  exitCancelledBody: "Non è stato addebitato nulla.",
  exitStillProcessing:
    "Il pagamento è ancora in elaborazione. Attendi un momento e ricarica la pagina.",
  exitAlreadyPaid: "Questo ordine è già pagato.",
  exitFailed: "Non ha funzionato. Riprova o rivolgiti al ristorante.",
  exitClose: "Chiudi",
  exitOtherOptions: "Altre opzioni",
...
const ar: PostOrderCopy = {
  ...
  exitTitle: "لم يكتمل الدفع",
  exitBody: "طلبك غير مدفوع، لذلك لم يستلمه المطبخ بعد. ماذا تريد أن تفعل؟",
  exitTryCard: "إعادة محاولة الدفع بالبطاقة",
  exitPayCash: "الدفع نقدًا في المطعم",
  exitCancel: "إلغاء الطلب",
  exitCancelConfirm: "هل تريد إلغاء هذا الطلب؟ لم يُدفع ولن يُخصم أي مبلغ.",
  exitWorking: "لحظة…",
  exitCashDoneTitle: "أُرسل الطلب إلى المطبخ",
  exitCashDoneBody: "ستدفع نقدًا في المطعم.",
  exitCancelledTitle: "أُلغي الطلب",
  exitCancelledBody: "لم يُخصم أي مبلغ.",
  exitStillProcessing: "لا يزال الدفع قيد المعالجة. انتظر قليلًا ثم أعد تحميل الصفحة.",
  exitAlreadyPaid: "هذا الطلب مدفوع بالفعل.",
  exitFailed: "لم ينجح ذلك. حاول مرة أخرى أو تواصل مع المطعم.",
  exitClose: "إغلاق",
  exitOtherOptions: "خيارات أخرى",
