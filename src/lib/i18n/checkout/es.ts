...
const es: CheckoutCopy = {
  ...
  closedPreorderNote: "Ahora estamos cerrados: puedes encargar para más tarde hoy.",
  closedDineIn: "Pedir en la mesa solo es posible durante el horario de apertura.",
  timeEarlier: "Antes",
  timeLater: "Después",
